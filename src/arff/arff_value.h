...
enum ArffValueEnum {
    ...
    NOMINAL,
    /** hierarchical (only used by ArffAttr) */
    H_NOMINAL,
    /** unknown */
    UNKNOWN_VAL
};
...
public:
    ...
    /**
     * @brief Constructor for vector data
     * @param vec vector of string value
     * @param convert whether to convert the 'STRING' to numerics [true]
     *
     * Note that if the type is 'STRING', then the function will try to
     * convert the given string to float. If the conversion fails then
     * only the string will kept as it is.
     */
    ArffValue(const std::vector<std::string>& vec);
    ...
    /**
     * @brief Set the data to be stored
     * @param str vector of string data
     */
    void set(const std::vector<std::string>& vec);
    ...
    /**
     * @brief Get the vector of string value
     * @return vector of string value
     */
     ...
     * @param right RHS
     */
    bool operator ==(const std::vector<std::string>& right) const;
     ...
     * @param right RHS
     */
    friend bool operator ==(const std::vector<std::string>& left, const ArffValue& right);
